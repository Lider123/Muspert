...
import com.babaetskv.muspert.app.presentation.tracks.TracksPresenter
import com.babaetskv.muspert.app.presentation.tracks.TracksView
...
class TracksFragment : PlaybackFragment(), TracksView {
    ...
    private val presenter: TracksPresenter by moxyPresenter {
        TracksPresenter(args.album, get(), get(), get(), get(), get(), get(), get(), get())
    }
