...
import com.babaetskv.muspert.app.databinding.FragmentFavoritesBinding
...
import com.babaetskv.muspert.app.presentation.favorites.FavoritesPresenter
import com.babaetskv.muspert.app.presentation.favorites.FavoritesView
...
class FavoritesFragment : PlaybackFragment(), FavoritesView {
    ...
    private val presenter: FavoritesPresenter by moxyPresenter {
        FavoritesPresenter(get(), get(), get(), get(), get(), get(), get(), get())
    }
